...
export const questions = new Map<number, string>([
  ...
  [25, "Welche Signalmittel sind für jedermann frei erhältlich?\na) Knicklichter / Leuchtstäbe.\nb) Signalpfeifen.\nc) Pressluftfanfaren."],
  [26, "a) Welche Signalwaffen können erlaubnisfrei erworben werden?\nb) Dürfen diese zugriffsbereit geführt werden?"],
  ...
  [40, "Wie hoch steigen Seenotsignalraketen bei senkrechtem Abschusswinkel?\na) Bis zu 50 Metern.\nb) Bis zu 300 Metern.\nc) Bis zu 200 Metern."],
  [41, "Brennen pyrotechnische Leuchtsätze weiter, wenn sie ins Wasser fallen?\na) Nein.\nb) Nur, wenn es sich um militärische Munition handelt.\nc) Ja."],
...
export const answers = new Map<number, string>([
  ...
  [3, "Die Signalpistole Kaliber 4 (26,5 mm) und die von der Physikalisch Technischen Bundesanstalt (PTB) zugelassenen Signalwaffen einschließlich Munition bzw. die von der Bundesanstalt für Materialforschung und -prüfung (BAM) zugelassenen sonstigen Notsignale."],
  ...
  [10, "a) Rot."],
  [11, "a) In Notfällen, wenn unter anderem Leib und Leben von Personen in Gefahr sind und dringend fremde Hilfe benötigt wird.\nb) In Notfällen, wenn bedeutende Sachwerte in Gefahr sind und dringend fremde Hilfe benötigt wird."],
  [12, "Soweit auf dem einzelnen Gegenstand nichts anderes vermerkt ist, max. 3 Jahre."],
  [13, "1. Feuchtigkeit,\n2. Korrosion,\n3. hohe Lagertemperaturen, mechanische Beschädigungen."],
  ...
  [16, "1. Kühl und trocken,\n2. Leicht zugänglich in unverschlossenen Behältern."],
  [17, "Signalwaffen mit dem Bauartzulassungszeichen der Physikalisch Technischen Bundesanstalt 'PTB im Kreis'."],
  ...
  [25, "a) Knicklichter / Leuchtstäbe.\nb) Signalpfeifen.\nc) Pressluftfanfaren."],
  [26, "a) Signalwaffen mit dem Bauartzulassungszeichen 'PTB im Kreis' (PTB = Physikalisch-Technische Bundesanstalt).\nb) Das Führen ist nur mit dem Kleinen Waffenschein erlaubt."],
  [27, "1. Signalraketen, rot.\n2. Fallschirmsignalraketen, rot.\n3. Handfackeln, rot.\n4. Rauchsignale, orange."],
  [28, "Rot und orange."],
  [29, "1. Auf freies Schussfeld achten (z.B. Mast und Segel),\n2. Signalgerät senkrecht (ggf. in den Wind geneigt) nach oben halten,\n3. beim Handhaben und Abfeuern nicht auf Personen richten und selbst nicht mit Körperteilen oder Kleidung vor die Mündung kommen, nicht an Versagern hantieren, sondern diese über Bord werfen."],
  [30, "a) Freies Schussfeld.\nb) Windrichtung und Abschusswinkel.\nc) Keine entflammbaren Gegenstände im Gefahrenbereich."],
  ...
  [33, "1. Verbrauchsdauer / Verfallsdatum beachten,\n2. auf Korrosion oder Beschädigung achten."],
  ...
  [52, "a) Handfackeln und Rauchkörper.\nb) Handsignalraketen mit Fallschirm."],
  [53, "Nein."],
